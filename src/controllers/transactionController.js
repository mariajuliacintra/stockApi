...
/*
CURLs para TransactionController:
...
// POST new transaction (requer um 'verifyJWT')
// actionDescription deve ser 'IN', 'OUT' ou 'AJUST'
...
// Exemplo: alterando a quantidade e a descrição da transação 1
