...
module.exports = {
                        ...
                        "application/json": {
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    message: { type: "string", example: "Localização criada com sucesso!" },
                                    data: {
                                        type: "object",
                                        properties: {
                                            locationId: { type: "integer", description: "ID da localização inserida" }
                                        }
                                    }
                                }
                            }
    ...
    "/location/{idLocation}": { // Uso de idLocation conforme o parâmetro comum
        "get": {
